            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('admin/category/add')}}">分类添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/category/index')}}">分类展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/type/add')}}">类型添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/type/index')}}">类型展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/attribute/add')}}">属性添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/attribute/index')}}">属性展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/goods/add')}}">商品添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/goods/index')}}">商品展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admin/product/index')}}">货品展示</a>
                        </li>
                    </ul>
                </li>
                <li class="line dk"></li>
